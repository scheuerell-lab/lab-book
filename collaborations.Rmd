...
Also note that under NO circumstance can the journal publish *any* version of the paper online before Mark gets the approval (ie, no online early, preprints, etc). If the journal does so, Mark gets in trouble, and the approving officer will sometimes search online for the paper title, authors, etc to make sure it hasn't been published online.
