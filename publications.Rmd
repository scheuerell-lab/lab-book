...
**Note**: Under no circumstances can we allow a journal to post a preprint, online early, or other draft of our paper _before_ Mark gets the BAO's approval.

### Open Access

The US government now requires its scientists to publish their research as open access (OA). As such, we will need to choose journals that have that option and we will need to cover the necessary costs. At present, the cooperative units program has agreed to cover these charges, but that may change at any time. For collaborators at the University of Washington, we have reduced or zero article processing charges for many journals, which can be found via searching [here](https://university-of-washington.openjournalfinder.com/).

### Copyright agreements

Many journals have standard copyright agreements that the ask authors to sign prior to article publication. For government authors, this often means checking a box indicating that the work was done as part of our official duties and therefore we hold no copyrights nor can we transfer them to anyone else. However, these generic agreements often contain conflicting statements and therefore they must be reviewed, and possibly changed, by staff at our headquarters. **Please by sure to check with Mark regarding any copyright agreement before signing on his behalf**.
