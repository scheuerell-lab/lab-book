...
Where and how to store your data is an important consideration. In general, you are responsible for backing up your data to the cloud, which may involve one or more services.
...
Data for your project should be pushed/pulled from GitHub as part of your regular workflow. Each project should be set up as a "research compendium" following one of the templates [here](https://github.com/scheuerell-lab/onboarding/tree/master/templates). Each of the compendia should be structured with a `/data/` folder that contains sub-folders for raw and derived datasets. It is important that you **do not** revise the raw data files outside of your workflow, and instead keep unchanged versions of them in the `/data/raw` folder.
